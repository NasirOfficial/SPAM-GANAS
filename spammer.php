...
class prankcall{
	...
	public function run(){
		while(true){
			echo "--> Mau Kirim Spam? (y/n) = ";
			$loop = $this->get();
			if($loop=="y" OR $loop=="n"){
				break;
			}else{
				echo "Jika iya jawab (y) jika tidak jawab (n)\n";
				continue;
			}
		}
		if($loop=="y"){
...
-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/
= [!] Author   : Mr.Ns                         
= [!] Youtube  : www.youtube.com/NasirOfficial    

= [!] github   : github.com/NasirOfficial         
-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/\n";
echo $red."
==========================
|[!]  Thanks To Termux [!]|
